...
public class SetUpAGameGUI extends JFrame {
    ...
    public SetUpAGameGUI() {
        ...
        bottomPanel.add(displaySettingsButton);
    ...
    private JPanel createPlayerColumn(int playerNumber) {
        ...
        for (int i = 0; i < playerTypes.length; i++) {
            ...
            playerTypeRadioButtons[playerNumber - 1][i].addActionListener(e -> updatePlayerColumn(playerNumber - 1));
        }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (!playerType.equals("None")) {
                ...
                if (playerType.equals("Human Player")) {
                    ...
                    participants.add(new Computer(name, color));
